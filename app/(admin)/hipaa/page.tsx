  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        ref: "§164.312(d)",
        status: "not_yet",
        detail: "MFA is not yet implemented. Recommended for production with PHI access.",
        configNote: "Integrate TOTP (e.g., speakeasy) or SMS-based MFA before production.",
      },
    ],
  },
  {
